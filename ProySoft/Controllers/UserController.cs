...
namespace ProySoft.Controllers
{
    public class UserController : Controller
    {
        ...
        public UserController(ProySoftContext context, IWebHostEnvironment webHostEnvironment)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("Email, Password")] UserDtoForLogin dto)
        {
